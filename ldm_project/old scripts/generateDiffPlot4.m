...
function out = generateDiffPlot4(data1,error1)
...
% temp1 = data(:,1) - data(:,2);
% temp2 = nanstd(temp1)*0.5;

idx = abs(temp1 - nanmean(temp1)) > temp2;
...
IBE = bootstrp(1000,@(x,y) IBEV10(x,y),data,...
                 error);
...
% drawnow
out(count,:) = [nanmean(IBE(:,1)) nanstd(IBE(:,1))];
count = count+1;
end
